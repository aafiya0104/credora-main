  ...
  <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
    ...
    <div className="container relative">
      ...
      <a href="#" className="inline-flex gap-3 border py-1 px-2 rounded-lg border-white/30">
       ...
       <span> 
        <span className="inline-flex items-center gap-1">Read More<ArrowIcon/></span>
      </span>
      </a>
      </div>
      ...
      <h1 className="text-7xl sm:text-9xl font-bold tracking-tighter text-center mt-8 inline-flex">
        ...
        <div className="flex justify-center">
      <p className="text-center text-xl mt-8 max-w-md">Celebrate the joy of accomplishment with an app designed to
        help you focus on one task at a time. Experience the satisfaction of
        completing tasks and enjoy the simplicity of a distraction-free
        environment.
        </p></div>
